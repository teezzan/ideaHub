...
export const ProfileCardDemo = React.memo(function ProfileCard() {
    ...
    return (
        <Card className={cx(styles.card, shadowStyles.root)}>
            <CardContent>
                <Avatar className={styles.avatar} src={'https://i.pravatar.cc/300'} style={{
                    color: 'white',
                    backgroundColor: "red",
                }} >
                    B
            ...
            <Box display={'flex'}>
                <Box component="span" m={2} flex={'auto'} className={borderedGridStyles.item}>
                    <Button className={styles.avatar}> Chat </Button>
                </Box>
            </Box>
        </Card>
    );
