    ...
    return (
        <List className={classes.root}>
            <ListItem button alignItems="flex-start" >
                ...
                <ListItemText
                    primary="Brunch this weekend? eighborhood doing errands thiseighborhood doing errands this"
                    secondary={
                        <React.Fragment>
                            <Typography
                                component="span"
                ...
                <ListItemText
                    ...
                    secondary={
                        <React.Fragment>
                            ...
                            {" — I'll be in your neighborhood doing errands this  Wish I could come, but I'm out of town this…"}
                        </React.Fragment>
                    }
                />
            </ListItem>
